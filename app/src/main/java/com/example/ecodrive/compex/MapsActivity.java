...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Camera view initialized on nagpur
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
               latLngArrayList.add(point);
                ...
                //for polyline between markers
//                if(latLngArrayList.size()>1)
//                {
//                    polyline = mMap.addPolyline(new PolylineOptions().addAll(latLngArrayList));
//                    polyline.setColor(ContextCompat.getColor(getBaseContext(), R.color.colorPrimaryDark));
//                    polyline.setEndCap(new RoundCap());polyline.setEndCap(new RoundCap());
...
//                    polyline = mMap.addPolyline(new PolylineOptions().add(marker1).add(marker2));
//                    polyline.setColor(ContextCompat.getColor(getBaseContext(), R.color.colorPrimaryDark));
//                    polyline.setEndCap(new RoundCap());polyline.setEndCap(new RoundCap());
//                    polyline.setWidth(14);
//                    markercount=0;
